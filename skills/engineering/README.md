...
- **[setup-parallaxisjones-skills](./setup-parallaxisjones-skills/SKILL.md)** — Scaffold the per-repo config (issue tracker, triage label vocabulary, domain doc layout) that the other engineering skills consume.
